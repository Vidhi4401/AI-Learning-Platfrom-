...
@router.post("/api/v1/admin/topics/{topic_id}/assignments")
...
@router.get("/api/v1/admin/topics/{topic_id}/assignments")
...
@router.put("/api/v1/admin/assignments/{assignment_id}")
...
@router.delete("/api/v1/admin/assignments/{assignment_id}")
