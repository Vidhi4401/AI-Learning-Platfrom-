...
@router.post("/api/v1/admin/topics/{topic_id}/quizzes")
def create_quiz(
    topic_id: int,
...
@router.put("/api/v1/admin/quizzes/{quiz_id}")
def update_quiz(
    quiz_id: int,
...
@router.delete("/api/v1/admin/quizzes/{quiz_id}")
def delete_quiz(
    quiz_id: int,
    db: Session = Depends(get_db),
    admin: models.User = Depends(get_current_admin)
...
@router.post("/api/v1/admin/quizzes/{quiz_id}/questions")
def add_question(
    quiz_id: int,
...
@router.put("/api/v1/admin/questions/{question_id}")
def update_question(
    question_id: int,
...
@router.delete("/api/v1/admin/questions/{question_id}")
def delete_question(
    question_id: int,
    db: Session = Depends(get_db),
    admin: models.User = Depends(get_current_admin)
